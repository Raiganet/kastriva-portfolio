...
const adminActions = new Set(['getDashboardStats', 'getOrders', 'getOrder', 'updateOrderStatus', 'getCustomers', 'getCustomer', 'getProjects', 'getProject', 'createProject', 'createProjectUpdate', 'getPortfolioAdmin', 'createPortfolio', 'updatePortfolio', 'deletePortfolio', 'createQuotation', 'getQuotations', 'adminSession', 'logout']);
const customerActions = new Set(['getMyDashboard', 'respondQuotation', 'getOrderByNumber', 'customerSession', 'customerLogout']);
