...
export default function WhatsAppFloat() {
  return (
    <a onClick={() => trackEvent("whatsapp_click", { placement: "floating_button" })} href={getWhatsAppLink("Halo Kastriva, saya tertarik menggunakan jasa pembuatan website/aplikasi. Saya ingin konsultasi mengenai project saya.")} target="_blank" rel="noopener noreferrer" aria-label="Konsultasi melalui WhatsApp" className="fixed bottom-[max(1.5rem,env(safe-area-inset-bottom))] right-4 md:right-6 z-40 bg-green-500 hover:bg-green-600 text-white p-4 rounded-full shadow-lg shadow-green-500/30 transition-all hover:scale-110 flex items-center gap-2 group">
